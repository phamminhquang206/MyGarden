import {SPECIES,validState} from './garden-core.js?v=11';
...
export function importBackup(text){
 ...
 if(!known(s.selectedSpecies)||!integer(s.duration,0,180)||!['rain','stream','ambient'].includes(s.sound)||!Number.isFinite(s.volume)||s.volume<0||s.volume>100)throw Error('Thiết lập bản sao lưu không hợp lệ.');
