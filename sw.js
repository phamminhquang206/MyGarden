const CACHE='mygarden-v14';
const ASSETS=['./','./index.html','./styles.css?v=14','./scripts.js?v=14','./backup.js?v=11','./duration-dial.js?v=11','./garden-core.js?v=11','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-maskable-512.png','./sound/liecio-calming-rain.mp3','./sound/alex_jauk-calm-zen-river-flowing-228223.mp3','./sound/focus.mp3'];
